...
<head>
    ...
    <meta charset="utf-8" />
    <title>İntibak Başvuru Ekranı | Koü Başvuru Sistemi</title>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item mx-2"><a href="javascript: void(0);">İntibak Başvuru Ekranı</a></li> -
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto ">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">İntibak Başvuru Formu</p>
                                    </div>
                                    <form class="needs-validation mt-3 pt-1" method="post" action="{{route('ogrenciler.basvurular.intibak-basvuru')}}">
                                        @csrf
                                        <div class="mb-2">
                                            <label for="username" class="form-label">Ad Soyad</label>
                                            <input type="text" class="form-control" id="username" name="ad_soyad" placeholder=" Lütfen Ad-Soyad Giriniz" required>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="email" class="form-control" id="useremail" name="email" placeholder="Lütfen email adresinizi giriniz." required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="username" name="tc_no" placeholder=" Lütfen TC NO Giriniz" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="tel" class="form-control" id="username" name="gsm" placeholder=" Lütfen Telefon No Giriniz" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="userpassword" name="ev_adres" placeholder="Lütfen ev adresi giriniz." required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="userpassword" name="is_adres" placeholder="Lütfen iş adresi giriniz." required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="number" class="form-control" id="userpassword" name="ogrenci_no" placeholder="Lütfen öğrenci no giriniz." required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            <label for="userpassword" class="form-label">Daha önce ders alınan üniversite</label>
                                            <input type="text" class="form-control" id="userpassword" name="intibak_universite" placeholder="Lütfen Üniversite Adı giriniz." required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            <label for="userpassword" class="form-label">Daha önce ders alınan fakülte</label>
                                            <select class="form-select" id="basvurulanfakulte" name="intibak_fakulte" onchange="populateBasvurulanItems(this.id,'basvurulanbolum')">
                                                <option value="">Fakülte Seçin...</option>
                                                <option value="muhendislik">Mühendislik Fakültesi</option>
                                                <option value="fenedebiyat">Fen Edebiyat Fakültesi</option>
                                                <option value="iletisim">İletişim Fakültesi</option>
                                        ...
                                        <div class="mb-2">
                                            <label for="userpassword" class="form-label">Daha önce ders alınan bölüm</label>
                                            <select class="form-select" name="intibak_bolum" id="basvurulanbolum">
                                                <option value="" name="bolumsec" id="bolumsec">Önce Fakülte seçin</option>
                                            </select>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-2">
                                            <label for="userpassword" class="form-label">Daha önce alınan dersler</label>
                                        </div>
                                        <div class="mb-2">
                                            <table class="table table-dark">
                                                ...
                                                <tr>
                                                    <th scope="row">1</th>
                                                    <td><input type="text" name="alinan_dersler[ders_adi]"></td>
                                                    <td><input type="text" name="alinan_dersler[t]"></td>
                                                    <td><input type="text" name="alinan_dersler[u]"></td>
                                                    <td><input type="text" name="alinan_dersler[l]"></td>
                                                    <td><input type="text" name="alinan_dersler[akts]"></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">2</th>
                                                    <td><input type="text" name="alinan_dersler[ders_adi]"></td>
                                        ...
                                        <div class="mb-2">
                                            <label for="userpassword" class="form-label">Bölümümde muaf olmak istediğim dersler</label>
                                        </div>
                                        <div class="mb-2">
                                            <table class="table table-dark">
                                                <thead>
