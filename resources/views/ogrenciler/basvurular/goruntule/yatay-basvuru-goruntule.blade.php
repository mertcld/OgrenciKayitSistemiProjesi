                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            ...
                            <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                ...
                                <li>
                                    <a href="{{route('admin.basvurular.reddedilenler.reddedilen-yatay-liste')}}" class="nav-link px-0"> <span class="d-none d-sm-inline">Reddedilen Başvurular</span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                                <li class="w-100">
                                    <a href="{{route('admin.basvurular.cap-basvuru-listesi')}}" class="nav-link px-0"> <span class="d-none d-sm-inline">Bekleyen Başvurular</span></a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="mb-2">
                    <div class="container text-center" style="overflow-x: auto;">
                        <h2 style="text-align: center; margin-top: 30px">Yatay Geçiş Başvurularım</h2>
                        <table class="table table-bordered border-dark">
                            ...
                            @foreach($yataybasvurular as $item)
                                ...
                                <tr>
                                    ...
                                    @if($item->basvuru_durumu == 'basvuru_onaylandi')
                                        <td><span class="bg-success">{{$item->basvuru_durumu}}</span></td>
                                    @else
                                        <td><span class="bg-danger">{{$item->basvuru_durumu}}</span></td>
                                    @endif
