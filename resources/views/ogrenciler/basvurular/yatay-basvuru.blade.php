...
<head>
    ...
    <meta charset="utf-8" />
    <title>Yatay Geçiş  Başvuru Ekranı | Koü Başvuru Sistemi</title>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{auth()->user()->photo}}"
                                    alt="Header Avatar">
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item mx-2"><a href="javascript: void(0);">Yatay Geçiş Başvuru Ekranı</a></li> -
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto ">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">Yatay Geçiş  Başvuru Formu</p>
                                    </div>
                                    <form class="needs-validation mt-3 pt-1" method="post" action="{{route('ogrenciler.basvurular.yatay-basvuru')}}">
                                    @csrf
                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Başvuru Türü</label>
                                        <select class="form-select" id="basvuru_turu" name="basvuru_turu">
                                            <option value="">Başvuru Türünü Seçin ...</option>
                                            <option value="Ek Madde-1 ile Kurum içi  Yatay Geçiş">Ek Madde-1 ile Kurum içi  Yatay Geçiş</option>
                                            <option value="Ek Madde-1 ile Kurumlar arası Geçi">Ek Madde-1 ile Kurumlar arası Geçiş</option>
                                            <option value="Başarıya Dayalı  Kurum içi  Yatay Geçiş">Başarıya Dayalı  Kurum içi  Yatay Geçiş</option>
                                            <option value="Başarıya Dayalı Kurumlar arası Geçiş">Başarıya Dayalı Kurumlar arası Geçiş</option>
                                        </select>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="ad_soyad" class="form-control" id="username" placeholder=" Lütfen Ad-Soyad Giriniz" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="email" name="email" class="form-control" id="useremail" placeholder="Lütfen email adresinizi giriniz." required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="tc_no" class="form-control" id="username" placeholder=" Lütfen TC NO Giriniz" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="tel" name="gsm" class="form-control" id="username" placeholder=" Lütfen Telefon No Giriniz" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="ev_adres" class="form-control" id="userpassword" placeholder="Lütfen ev adresi giriniz." required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="is_adres" class="form-control" id="userpassword" placeholder="Lütfen iş adresi giriniz.">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="number" name="ogrenci_no" class="form-control" id="userpassword" placeholder="Lütfen öğrenci no giriniz." required>
                                        <div class="invalid-feedback">
                                            Lütfen öğrenci no giriniz.
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Sınıf</label>
                                        <input type="number" name="ogrenci_sinif" class="form-control" id="userpassword" placeholder="Lütfen sınıf giriniz." required>
                                        <div class="invalid-feedback">
                                            Lütfen sınıf giriniz.
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Öğrenci Yerleşme Yılı</label>
                                        <input type="number" name="yerlesme_yili" class="form-control" id="userpassword" placeholder="Yerleşme yılınızı giriniz." required>
                                        <div class="invalid-feedback">
                                            Öğrenci yerleşme yılı.
                                        </div>
                                    </div>

                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Öğrenci Yerleşme Puanı</label>
                                        <input type="number" class="form-control" name="yerlesme_puani" id="userpassword" placeholder="Yerleşme puanınızı giriniz." required>
                                        <div class="invalid-feedback">
                                            Öğrenci yerleşme puanı.
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Öğrenci GNO</label>
                                        <input type="number" name="not_gno" class="form-control" id="userpassword" placeholder="Not ortalamanızı(AGNO)  giriniz." required>
                                        <div class="invalid-feedback">
                                            Öğrenci not ortalaması.
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Öğrenci YDP</label>
                                        <input type="number" name="ogrenci_ydp" class="form-control" id="userpassword" placeholder="Yabancı Dil Puanınızı  giriniz." required>
                                        <div class="invalid-feedback">
                                            Yabancı Dil Puanı.
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Başvurulan Fakülte</label>
                                        <select class="form-select" id="basvurulanfakulte" name="basvurulan_fakulte" onchange="populateBasvurulanItems(this.id,'basvurulanbolum')">
                                            <option value="">Fakülte Seçin...</option>
                                            <option value="Mühendislik Fakültesi">Mühendislik Fakültesi</option>
                                            <option value="Fen Edebiyat Fakültesi">Fen Edebiyat Fakültesi</option>
                                            <option value="İletişim Fakültesi">İletişim Fakültesi</option>
                                    ...
                                    <div class="mb-2">
                                        <label for="userpassword" class="form-label">Bölüm Adı</label>
                                        <select class="form-select" name="basvurulan_bolum" id="basvurulanbolum">
                                            <option value="" name="bolumsec" id="bolumsec">Önce Fakülte seçin</option>
