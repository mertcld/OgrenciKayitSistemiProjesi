...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | Onaylı Yatay Geçiş Başvuru Listesi</title>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item mx-2"><a href="javascript: void(0);">Onaylı Yatay Geçiş Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Onaylı Yatay Geçiş Başvuruları</h4>
...
<script>
    ...
    $("#datatable-buttons").DataTable({
        ...
        buttons:["excel","pdf"]}).buttons().container().appendTo("#datatable-buttons_wrapper .col-md-6:eq(0)"),
