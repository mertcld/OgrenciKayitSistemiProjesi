                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <li><a href="{{route('admin.basvurular.yazokulu-basvuru-listesi')}}" data-key="t-login">Bekleyen Başvurular</a></li>
                                <li class="active show"><a href="{{route('admin.basvurular.onaylilar.onayli-yazokulu-liste')}}" data-key="t-register">Onaylanan Başvurular</a></li>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item mx-2"><a href="javascript: void(0);">Onaylı Yaz Okulu Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Onaylı Yaz Okulu Başvuruları</h4>
