...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | Yatay Geçiş Başvuru Listesi</title>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Yatay Geçiş Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Bekleyen Yatay Geçiş Başvuruları</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-soft-success" href="{{route('admin.basvurular.onayla.yatay-basvuru-onayla',$item->id)}}">Başvuruyu Onayla</a>
                                            <a class="btn btn-soft-danger" href="{{route('admin.basvurular.reddet.yatay-basvuru-reddet',$item->id)}}">Başvuruyu Reddet</a>
                                        </td>
                                    </tr>
                                @endforeach
                                        </tbody>
