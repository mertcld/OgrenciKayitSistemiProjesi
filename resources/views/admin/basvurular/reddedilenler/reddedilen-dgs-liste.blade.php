...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | Reddedilen DGS Başvuru Listesi</title>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <li><a href="{{route('admin.basvurular.dgs-basvuru-listesi')}}" data-key="t-login">Bekleyen Başvurular</a></li>
                                ...
                                <li class="active show"><a href="{{route('admin.basvurular.reddedilenler.reddedilen-dgs-liste')}}" data-key="t-recover-password">Reddedilen Başvurular</a></li>
                            </ul>
                        </li>
                       <li>
                            <a href="javascript: void(0);" class="has-arrow">
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item mx-2"><a href="javascript: void(0);">Reddedilen DGS  Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Reddedilen DGS  Başvuruları</h4>
                                ...
                                <tr>
                                    ...
                                    <td><span class="bg-danger">{{$item->basvuru_durumu}}</td>
