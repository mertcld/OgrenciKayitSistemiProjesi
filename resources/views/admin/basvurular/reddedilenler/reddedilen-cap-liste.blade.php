...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | Reddedilen ÇAP Başvuru Listesi</title>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li  class="active show"><a href="{{route('admin.basvurular.reddedilenler.reddedilen-cap-liste')}}" data-key="t-recover-password">Reddedilen Başvurular</a></li>
                                </ul>
                        </li>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item mx-2"><a href="javascript: void(0);">Reddedilen ÇAP Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Reddedilen ÇAP Başvuruları</h4>
                                ...
                                <th>Belge Oluşturulma Zamanı</th>
                                    ...
                                    <td>{{$item->ogrenci_yariyil}}</td>
                                    <td>{{$item->ogrenci_gno}}</td>
                                    <td>{{$item->cap_fakulte}}</td>
                                    <td>{{$item->cap_bolum}}</td>
                                        <td><span class="ms-2 fas fa-times-circle text-danger"></span>
                                           {{$item->basvuru_durumu}} <span class="ms-2 fas fa-times-circle text-danger"></span></td>
