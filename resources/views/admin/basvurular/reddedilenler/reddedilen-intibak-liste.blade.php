...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | Reddedilen İntibak Başvuru Listesi</title>
                       ...
                       <li>
                        ...
                        <li>
                            ...
                            <li><a href="#" data-key="t-login">Bekleyen Başvurular</a></li>
                                ...
                                <li class="active show"><a href="#" data-key="t-recover-password">Reddedilen Başvurular</a></li>
                            </ul>
                        </li>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item mx-2"><a href="javascript: void(0);">Reddedilen İntibak  Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Reddedilen İntibak  Başvuruları</h4>
