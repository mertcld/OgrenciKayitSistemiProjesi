...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | Yaz Okulu Başvuru Listesi</title>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                       ...
                       <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                            <li class="show active"><a href="{{route('admin.basvurular.yazokulu-basvuru-listesi')}}" data-key="t-login">Bekleyen Başvurular</a></li>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Yaz Okulu Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Bekleyen Yaz Okulu Başvuruları</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-soft-success" href="{{route('admin.basvurular.onayla.yazokulu-basvuru-onayla',$item->id)}}">Başvuruyu Onayla</a>
