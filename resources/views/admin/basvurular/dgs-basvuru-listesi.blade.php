...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | DGS Başvuru Listesi</title>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li> 
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                            <li class="active show"><a href="{{route('admin.basvurular.dgs-basvuru-listesi')}}" data-key="t-login">Bekleyen Başvurular</a></li>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">DGS Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Bekleyen DGS Başvuruları</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-soft-success" href="{{route('admin.basvurular.onayla.dgs-basvuru-onayla',$item->id)}}">Başvuruyu Onayla</a>
                                            <a class="btn btn-soft-danger" href="{{route('admin.basvurular.reddet.dgs-basvuru-reddet',$item->id)}}">Başvuruyu Reddet</a>
                                        </td>
                                    </tr>
                                @endforeach
                                        </tbody>
