...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | İntibak Başvuru Listesi</title>
...
<body>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{route('admin.basvurular.cap-basvuru-listesi')}}" data-key="t-login">Bekleyen Başvurular</a></li>
                        ...
                        <li> 
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                            <li ><a href="#" data-key="t-login">Bekleyen Başvurular</a></li>
                                <li><a href="#" data-key="t-register">Onaylanan Başvurular</a></li>
                                <li><a href="#" data-key="t-recover-password">Reddedilen Başvurular</a></li>
                            </ul>
                        </li>
                       <li>
                            <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                            <li class="active show"><a href="{{route('admin.basvurular.intibak-basvuru-listesi')}}" data-key="t-login">Bekleyen Başvurular</a></li>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">İntibak Başvuruları</a></li> -
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Bekleyen İntibak Başvuruları</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <th>İşlemler</th>
                                        ...
                                        <tbody>
                                        @foreach($intibakbasvurular as $item)
                                    <tr>
                                        <td>{{$item->id}}</td>
                                        <td>{{$item->ad_soyad}}</td>
                                        <td>{{$item->email}}</td>
                                        ...
                                        <td>{{$item->intibak_universite}}</td>
                                        <td>{{$item->intibak_fakulte}}</td>
                                        <td>{{$item->intibak_bolum}}</td>
                                        <td>{{$item->created_at}}</td>
                                        <td>{{$item->basvuru_durumu}}</td>
                                        <td>
                                            <a class="btn btn-soft-success" href="{{route('admin.basvurular.onayla.intibak-basvuru-onayla',$item->id)}}">Başvuruyu Onayla</a>
                                            <a class="btn btn-soft-danger" href="{{route('admin.basvurular.reddet.intibak-basvuru-reddet',$item->id)}}">Başvuruyu Reddet</a>
                                        </td>
                                    </tr>
                                @endforeach
                                        </tbody>
    ...
    <!-- Datatable init js -->
<script>
    $(document).ready(function(){$("#datatable").DataTable(),$("#datatable-buttons").DataTable({lengthChange:!1,buttons:["excel","pdf"]}).buttons().container().appendTo("#datatable-buttons_wrapper .col-md-6:eq(0)"),$(".dataTables_length select").addClass("form-select form-select-sm")});
</script>
